      ...
      <article className="col-md-12">
        ...
        {/* <img src={album.image} alt="album image" className="card-img-top w-50 h-50 d-black mx-auto" />*/}
          <div className="card-body text-center">
            {/* <h4 className="card-title">{ablum.title}</h4> */}
            <div className="d-flex justify-context-center align-items-center mb-2">
                {/* <p className="card-title">{album.artist} </p>*/}
                {/* <img src={album.thumnail_image} alt="artist image" style={{ height: '8%', width: '8%'}} className="mx-3 border"/>*/}
            </div>
              {/* <a href={album.url} target="_blank" className="btn btn-secondary shado btn-block mx-auto">Buy on Amazon</a>*/}
              {/* */}
            <button
              // onClick={}
